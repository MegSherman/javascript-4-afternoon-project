...
function Car (make, model, year) {
  ...
  */
  ...
  Movie.prototype.changeRating = function (newRating) {
    let total = this.rating * newRating
    let average = total / 2
    this.rating = average
    return average
  }
...
User.prototype.addSavedPost = function (id, title, rating) {
  ...
  this.savedPosts.push (newObject)
}
...
User.prototype.changePostRating = function (id, newRating) {
  ...
  //   this.savedPosts.forEach (function (newId) {
//     if (newId === this.savedPosts[i].id) {
//       let total = this.savedPosts[i].rating * newRating
//       let average = total / this.savedPosts.length
//       this.savedPosts.rating = average
//     }
//   })
// }
